...
data = pd.read_csv("assets/P1_7A_Optical_Clearing_imgs.csv")

logging.debug(f"Data columns imported for p1-7a-optical-clearing:\n{data.columns}")
...
layout = html.Div(
    html.Section(
        children=[
            html.Header(html.H2("P1-7A Optical Clearing Files")),
            grid,
        ],
    )
)
