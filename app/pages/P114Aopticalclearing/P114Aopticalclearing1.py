...
im = iio.imread(
'assets/optical-clearing-czi/P1-14A/P1_14A1_ KRT19 green INS white stack_Maximum intensity projection.tif'
)
vols = []
...
def download_czi(n_clicks):
    ...
    return dcc.send_file(
        "assets/optical-clearing-czi/P1-14A/P1_14A1_ KRT19 green INS white stack_Maximum intensity projection.czi"
    )
