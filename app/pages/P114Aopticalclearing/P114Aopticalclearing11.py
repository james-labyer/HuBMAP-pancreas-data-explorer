...
im = iio.imread(
'assets/optical-clearing-czi/P1_14A2_CD31 red INS white stack high res_Maximum intensity projection.tif'
)
vols = []
...
def download_czi(n_clicks):
    ...
    return dcc.send_file(
        "assets/optical-clearing-czi/P1_14A2_CD31 red INS white stack high res_Maximum intensity projection.czi"
    )
