...
slices_img = BioImage("assets/optical-clearing-czi/P1-14A/P1_14A1_KRT green stack.czi", reader=bioio_czi.Reader)
...
def download_czi(n_clicks):
    logging.info(
        "Sending P1_14A1_KRT green stack.czi"
    )
    return dcc.send_file(
        "assets/optical-clearing-czi/P1-14A/P1_14A1_KRT green stack.czi"
    )
