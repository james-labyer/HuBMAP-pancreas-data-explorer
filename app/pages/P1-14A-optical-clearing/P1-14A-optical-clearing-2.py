...
im = iio.imread(
'assets/optical-clearing-czi/P1_14A1_ KRT19 green INS white stack.tif'
)
temp0 = []
temp1 = []
for i in range(14):
...
txt2 =register_page(
    __name__,
    path="/P1-14A-optical-clearing/P1-14A-optical-clearing-2",
    title="P1-14A optical clearing #2",
)
breadcrumb = dbc.Breadcrumb(
    items=[
        {"label": "Home", "href": "/", "external_link": False},
       {
        ...
        {"label": "P1-14A optical clearing #2", "active": True},
    ],
)
...
layout = [
    breadcrumb,
    html.Section(
        id="P1-14A-optical-clearing-2",
        className="slicer-card",
        children=[
            html.Header(html.H2("View P1-14A optical clearing #2")),
            html.P("P1_14A1_ KRT19 green INS white stack.czi"),
            html.Div(
                [
                    html.Div(
                        children=[
            ...
            html.Div(
                children=[
                    ...
                    dbc.Button(
                        "Download .czi",
                        id="btn-download-P1-14A-optical-clearing-2",
                        className="download-button",
                    ),
                    dcc.Download(id="download-P1-14A-optical-clearing-2"),
                ]
            ),
        ],
    ),
...
@callback(
    ...
    Input("P1-14A-optical-clearing-2", "children"),
    Input(slicer1.slider, "value"),
)
def apply_levels(level, children):
    return slicer1.create_overlay_data(vol1, colors)
@callback(
    Output("download-P1-14A-optical-clearing-2", "data"),
    Input("btn-download-P1-14A-optical-clearing-2", "n_clicks"),
    prevent_initial_call=True,
)
def download_czi(n_clicks):
    return dcc.send_file(
        "assets/optical-clearing-czi/P1_14A1_ KRT19 green INS white stack.czi"    )
