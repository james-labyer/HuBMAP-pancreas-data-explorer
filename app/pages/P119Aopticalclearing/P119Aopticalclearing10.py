...
slices_img = BioImage("assets/optical-clearing-czi/P1-19A/P1_19A2 INS tile scan_Stitch.czi", reader=bioio_czi.Reader)
...
def download_czi(n_clicks):
    logging.info(
        "Sending P1_19A2 INS tile scan_Stitch.czi"
    )
