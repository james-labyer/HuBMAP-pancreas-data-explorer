...
layout = [
    html.Section(
        id="P1-7A-optical-clearing-8",
        children=[
            html.Header(html.H2("View P1-7A optical clearing #8")),
            html.P("P1_7A2_stack NY CD31 INS no KRT_Maximum intensity projection.czi"),
            html.Div(
                [
                    dbc.Card(
                        dbc.CardBody(
            ...
            html.Div(
                children=[
                    ...
                    dbc.Button(
                        "Download",
                        id="btn-download-P1-7A-optical-clearing-8",
                        className="download-button",
                    ),
                    dcc.Download(id="download-P1-7A-optical-clearing-8"),
                ]
            ),
        ],
    ),
...
def download_file(n_clicks):
    logging.info(
        "Sending P1_7A2_stack NY CD31 INS no KRT_Maximum intensity projection.czi"
    )
