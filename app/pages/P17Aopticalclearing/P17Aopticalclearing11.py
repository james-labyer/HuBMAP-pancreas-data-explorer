...
layout = [
    html.Section(
        id="P1-7A-optical-clearing-11",
        children=[
            html.Header(html.H2("View P1-7A optical clearing #11")),
            ...
            html.Div(
                children=[
                    ...
                    dbc.Button(
                        "Download",
                        id="btn-download-P1-7A-optical-clearing-11",
                        className="download-button",
                    ),
                    dcc.Download(id="download-P1-7A-optical-clearing-11"),
                ]
            ),
        ],
    ),
